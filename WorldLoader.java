...
public class WorldLoader {
    ...
    public static final String WORM_KEY = "oruga";
    public static final String HOLE_KEY = "hole";
    public static final String BUTTERFLY_KEY = "butterfly";
...
//    private static void parseWorm(WorldModel world, String[] properties, Point pt, String id, ImageStore imageStore) {
//        if (properties.length == WORM_NUM_PROPERTIES) {
//            Entity entity = Factory.createWorm(id, pt, Double.parseDouble(properties[WORM_ACTION_PERIOD]), Double.parseDouble(properties[WORM_ANIMATION_PERIOD]), imageStore.getImageList(WORM_KEY));
//            world.tryAddEntity(entity);
//        }else{
//            throw new IllegalArgumentException(String.format("%s requires %d properties when parsing", WORM_KEY, WORM_NUM_PROPERTIES));
//        }
//    }
