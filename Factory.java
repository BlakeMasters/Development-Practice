...
public final class Factory {
    ...
    public static Action createAnimationAction(EntityAnimated entity, int repeatCount) {
    ...
    public static Entity createHole(String id, Point position, List<PImage> images) {
        return new Stump(id, position, images);
    }
    ...
    public static Entity createFairy(String id, Point position, double actionPeriod, double animationPeriod, List<PImage> images) {
        return new Fairy(id, position, images, actionPeriod, animationPeriod); //0 health 0 other thing
    }
    public static Entity createWorm(String id, Point position, double actionPeriod, double animationPeriod, List<PImage> images) {
        return new Worm(id, position, images, actionPeriod, animationPeriod); //0 health 0 other thing
    }
    public static Entity createBut(String id, Point position, double actionPeriod, double animationPeriod, List<PImage> images) {
        return new Butterfly(id, position, images, actionPeriod, animationPeriod); //0 health 0 other thing
    }
